 ...
 */
 function hostCreateNewGame(genQuestions, timeForQuestion, numOfQuestions) {
    // Create a unique Socket.IO Room
    var thisGameId;
    do{
    thisGameId = ( Math.random() * 100000 ) | 0; //  | 0 means rounding down a number
    ...
    questions[thisGameId]=genQuestions; //init array that will store question generated by host
    options[thisGameId]["timeForQuestion"]=timeForQuestion;
    options[thisGameId]["numOfQuestions"]=numOfQuestion;
...
/* *************************
  ...
  function sendQuestions(playersSockets, gameId){
    ...
    var numberOfQuestions = options[gameId]["timeForQuestion"]; 
    var timeForQuestion = options[gameId]["numOfQuestions"] * 1000;  
    var time = 0;
...
function endGame(gameId){ //TODO TEST IN MONGODB AND CHECKING ON SERVER SIDE
    ...
    questions[gameId] = undefined; //decostructor
